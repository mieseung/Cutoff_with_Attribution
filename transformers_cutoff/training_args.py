...
class TrainingArguments:
    ...
    **which relate to the training loop itself**.
    ...
    warmup_ratio: float = field(default=0.06, metadata={"help": "Linear warmup over warmup_ratio if warmup_steps not set"})

    do_aug: bool = field(default=False)
    aug_type: Optional[str] = field(default='span_cutoff', metadata={'help': 'choices {span_cutoff, token_cutoff, dim_cutoff}'})
